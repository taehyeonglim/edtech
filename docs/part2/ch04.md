...
1. Gagné의 학습 조건 관점에서 학습 결과 유형과 수업 설계의 관계를 설명할 수 있다.
...
사전 읽기는 약 40분으로 계획한다. 목표마다 필요한 학습 조건이 다르다는 점에 유의하며 읽는다.

| 학습 목표 | 어디서 배우는가 | 무엇으로 확인하는가 |
| --- | --- | --- |
| 1. 학습 결과 유형과 수업 설계의 관계를 설명한다 | 1~2절[^gagne1965][^gagne1992] | 형성 평가 1번 |
| 2. 9가지 교수사태를 외적 조건으로 해석한다 | 2절[^gagne1992][^niu2020] | 형성 평가 3번 |
| 3. 학습위계와 내용 계열화의 연결을 설명한다 | 3절[^reigeluth1979][^reigeluth2014] | 형성 평가 2번 |
| 4. 정교화 이론과 개정 블룸 분류표로 목표를 점검한다 | 4절[^bloom1956][^ak2001][^krathwohl2002] | 형성 평가 4번, 5번 |

<!-- alignment-map (편집용, 화면 비노출)
objectives: ch04-o1, ch04-o2, ch04-o3, ch04-o4
activity_ids: ch04-precheck, ch04-conditions-alignment
assessment_ids: ch04-fa-1, ch04-fa-2, ch04-fa-3, ch04-fa-4, ch04-fa-5
source_ids: gagne1965, gagne1992, niu2020, reigeluth1979, reigeluth2014, bloom1956, ak2001, krathwohl2002
-->

- **읽기 전(5분)**: 누적 수업안의 목표 하나를 보고 학생이 먼저 할 수 있어야 할 기능 두 가지를 적는다.
- **읽은 뒤(10분)**: 한 활동에서 선수학습 회상, 수행 기회, 피드백 중 빠진 조건을 표시하고 보완 문장을 쓴다.
...
Gagné의 *The Conditions of Learning*은 학습 결과의 종류와 그것을 가능하게 하는 조건을 함께 분석하는 관점을 제시했다.[^gagne1965] 이 관점에서 교사의 첫 질문은 “무엇을 재미있게 보여 줄까?”보다 “학생이 수업 뒤 무엇을 할 수 있어야 하는가?”다.
...
<figure class="chapter-visual">
  <img src="../../../assets/visuals/generated/learning-conditions-classroom.jpg" alt="회상, 절차 연습, 문제 해결, 협력 활동을 서로 다른 지원으로 수행하는 학습자들" loading="lazy">
  <figcaption><span>목표 수행이 달라지면 필요한 예시·연습·피드백의 조건도 달라진다.</span><span class="chapter-visual-source">시각자료: OpenAI GPT Image로 생성 · 2026</span></figcaption>
</figure>

## 2. 학습 결과와 교수사태를 연결하기

Gagné, Briggs, Wager는 학습 결과를 언어정보, 지적기능, 인지전략, 태도, 운동기능으로 구분하는 교수설계 관점을 제시한다.[^gagne1992] 이 분류의 목적은 이름을 외우는 데 있지 않다. 목표 수행에 맞추어 어떤 지원을 마련할지 판단하는 데 있다.
...
<figure class="chapter-visual">
  <img src="../../../assets/visuals/generated/nine-events-classroom.jpg" alt="주의에서 목표, 회상, 안내, 연습, 피드백, 평가, 전이로 이어지는 수업 장면" loading="lazy">
  <figcaption><span>교수사태는 고정된 수업 각본이 아니라 학습자의 내적 처리를 돕는 조건을 진단하는 흐름이다.</span><span class="chapter-visual-source">시각자료: OpenAI GPT Image로 생성 · 2026</span></figcaption>
</figure>
...
Gagné 계열 교수설계는 학습 결과를 언어정보, 지적기능, 인지전략, 태도, 운동기능으로 구분하고 각 결과에 맞는 조건을 설계하도록 한다.[^gagne1992] 역사 용어 기억에는 의미 조직과 인출 연습이, 민주적 의사결정 원리 적용에는 사례 비교와 판단 근거 제시가 더 필요할 수 있다.
